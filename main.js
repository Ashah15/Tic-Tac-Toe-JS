...
//     document.querySelector('.first-player-name').innerHTML = console.log('test');
//     document.querySelector('.second-player-name').innerHTML = console.log('test');
//   }
...
// const player1Btn = document.getElementById(you add the player 1 button id here)
// const player1Input = document.getElementById(The id of the input for the name field)
// player1Btn.addEventListener('click', () => {
//   // just consoling hte value but you should put it inside some variable to use later
